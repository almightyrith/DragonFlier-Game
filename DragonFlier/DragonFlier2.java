...
public class DragonFlier2
{
    ...
    public static void main(String[] args) {
        DragonFlier2 dragonFlier2 = new DragonFlier2();
        DragonFlier2.GamePane gamePane = dragonFlier2.new GamePane();
        JFrame frame = new JFrame("Dragon Flier 2");
        frame.add(gamePane);
        frame.pack();
    ...
    public DragonFlier2() {
        ...
        EventQueue.invokeLater(new Runnable() {
                ...
                public void run() {
                    ...
                    gp.setPreferredSize(new Dimension(FRAME_WIDTH, FRAME_WIDTH));
                    frame.add(gp); // This adds the GamePane to the contentPane of the frame
                    ...
                    frame.setResizable(false); // so the user can't resize it.
    ...
    private class GamePane extends JPanel {
        ...
        public void displaySecondsElapsed(Graphics g){
            ...
            int y = 35;
            int shadowOffset = 3;
            long seconds = (System.currentTimeMillis() - this.startTime) / 1000; // Use long to avoid integer overflow
            String s = "" + seconds;
            g.drawString(s , x, y);
        ...
        public void collisionchecker() {
            ...
            if (dragon == null || fireball == null || eggList == null) {
                // Ensure dragon, fireball, and eggList are properly initialized
                return;
            }
